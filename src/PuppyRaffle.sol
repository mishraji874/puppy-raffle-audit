...
// @audit-info why are you using this version??
...
contract PuppyRaffle is ERC721, Ownable {
    ...
    function selectWinner() external {
        // q Does this follow CEI(Checks Effects Interactions) ? -> no
        // @audit-info recommend to follow CEI
        // q Aree the duration and start time being set correct ?
        require(block.timestamp >= raffleStartTime + raffleDuration, "PuppyRaffle: Raffle not over");
        require(players.length >= 4, "PuppyRaffle: Need at least 4 players");

        // @audit randomness
        // fiex: Chainlink VRF, Commit Reveal Scheme
        uint256 winnerIndex =
        ...
        // q is the 80% correct? -> Yes correct
        // q i bet there is an arithmetic error...
        ...
        // @audit overflow
        // fixes: Newer version of solidity, bigger units

        // max value: 18.446744073709551615
        // uint256: 20.000000000000000000
        // uint64 casting of 20 eth: 1.553255926290448384
        // @audit unsafe cast of uint256 to uint64
        totalFees = totalFees + uint64(fee);

        // e when we mint a new puppy NFT, we use the winnerIndex to determine rarity
        ...
        // q if our transaction picks a winner and we don't like it
        // q gas war... // @followup
        ...
        // q what if the current winner is a smart contract with a fallback that will fail?
    ...
    function withdrawFees() external {
        ...
        totalFees = 0;
        // q what if the feesAddress is a smart contract with a fallback that will fail?
